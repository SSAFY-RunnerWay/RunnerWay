...
CREATE TABLE `badge` (
  ...
  `badge_items_id` bigint NOT NULL,
  `get_time` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`badge_id`),
  KEY `member_id` (`member_id`),
  KEY `badge_items_id` (`badge_items_id`),
  CONSTRAINT `badge_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`),
  CONSTRAINT `badge_ibfk_2` FOREIGN KEY (`badge_items_id`) REFERENCES `badge_items` (`badge_items_id`)
...
--
-- Table structure for table `badge_image`
--

DROP TABLE IF EXISTS `badge_image`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `badge_image` (
  `badge_items_id` bigint NOT NULL,
  `url` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`badge_items_id`),
  CONSTRAINT `badge_image_ibfk_1` FOREIGN KEY (`badge_items_id`) REFERENCES `badge_items` (`badge_items_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `badge_image`
--

LOCK TABLES `badge_image` WRITE;
/*!40000 ALTER TABLE `badge_image` DISABLE KEYS */;
/*!40000 ALTER TABLE `badge_image` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `badge_items`
--

DROP TABLE IF EXISTS `badge_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `badge_items` (
  `badge_items_id` bigint NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `badge_items`
--

LOCK TABLES `badge_items` WRITE;
/*!40000 ALTER TABLE `badge_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `badge_items` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-10-10 17:09:28
